      ...
      <div class="content p-4">
        ...
        <div class="card mb-4">
          ...
          <div class="card-body">
            ...
            <button class="btn btn-danger ml-3" v-on:click="confirmAlert();">Confirm Alert</button>
          </div>
        </div>
        <div class="card mb-4">
          <div class="card-header bg-white font-weight-bold">
...
export default {
  ...
  methods: {
    ...
    toastrSimple: function () {
      window.toastr["success"]("My name is Inigo Montoya. You killed my father. Prepare to die!")
    }
  }
}
</script>
